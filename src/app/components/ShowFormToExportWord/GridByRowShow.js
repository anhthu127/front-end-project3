...
const GridByRowShowExport = (props) => {
    ...
    return (
        <>
            <Fragment key={`view-grid-row-${props.item.id}-${props.item.unique}`}>
                <div>
                        ...
                        <thead>
                            <tr className="border-table">
                                ...
                                {props.data.isHasOther === 1 && <th>{props.data.question_other &&
                                    props.data.question_other.other_title ? `${props.data.question_other.other_title}` : 'Ý kiến khác'}</th>}
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                return (
                                    <tr key={i} className="border-table">
                                        <td style={{
                                            ...
                                            padding: "8px ",
                                            borderWidth: "thin",
                                        }}>{item.title} {item.unit ? `(${item.unit})` : ""}</td>
                                        ...
                                        {props.data.isHasOther === 1 && <td style={{ margin: 'auto', textAlign: 'center', border: "1px solid #f0f0f0 ", borderWidth: 'thin' }}>
...
export default GridByRowShowExport;
