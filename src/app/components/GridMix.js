...
const GridMix = (props) => {
  ...
  const [columnLabel, setColumnLabel] = useState([
    { title: "Nội dung cột 1", type: STRING, unique: 'abcdefgh', unit: '' },
    { title: "Nội dung cột 2", type: CHECKBOX, unique: 'iklmnopq', unit: '' },
              ...
              <table className="table-width-view">
                <thead>
                  <tr>
                    ...
                    {columnLabel.map((e, i) => {
                      return <th key={i} className='td-table-create-question th-table-question-view'>{e.title} {e.unit ? `(${e.unit})` : ""} </th>;
                    })}
                  </tr>
                </thead>
                <tbody>
